...
def f_isochrone2(l2, temps_initial_iso):
    ...
    #************************************************************************
    nb_points_isochrone=100    #************************************************************************
    coeff1=nb_points_isochrone-1
    print()
...
# pour chacun des points de l'isochrone 
    ...
    coeff2   = coeff1/ (capmaxi2-capmini2)  # coefficient pour ecremer et garder 50 points
...
# definition des temps des isochrones
    ...
    #print ('tempscumules' , temps_cumules)
#base
    but = False
