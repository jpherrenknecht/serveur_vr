...
temps          = instant
#Depart
latitude_d     = '049-00-37-N'
longitude_d    = '003-32-55-W'
#Point Arrivee 
...
isochrone     = np.array([[D.real, D.imag, 0, 0, 0]])
...
l=1
# TWS et TWD en  variantes globales ( on les calcule qu'une fois en fin de calcul d'isochrone )
TWS, TWD = prevision_tableau3(tig, GR, temps, pt1_np)
